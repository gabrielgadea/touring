#!/usr/bin/env python3
"""W1.discover — Create root README.md + docs/landing/ + ASCII CLI banner for Premium Elite product first impression.

Forensic sub-script for W1 — Foundational README + Brand Layer.

Outputs
-------
  - data/W1-discover.json   (machine-readable JSON envelope)
- staging/W1-discover.md  (human-readable narrative)
Usage
-----
    python3 discover.py            # dry-run mode (default)
    python3 discover.py --apply    # actual mutation
    python3 discover.py -j         # JSON-only stdout (machine-readable)
"""
...
_DATA_DIR = _ROOT / "scripts/touring-47-to-13-residual/data"
_STAGING_DIR = _ROOT / "scripts/touring-47-to-13-residual/staging"
_WAVE = "W1"
_NAME = "discover"
