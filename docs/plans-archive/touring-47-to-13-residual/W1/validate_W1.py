#!/usr/bin/env python3
"""validate_W1 — Per-wave validator for touring-47-to-13-residual.

Reads ``data/W1-*.json`` artifacts produced by the wave's sub-scripts
...
Usage
-----
    python3 validate_W1.py            # default — table output
    python3 validate_W1.py -j         # machine-readable JSON
    python3 validate_W1.py --strict   # exit 1 on PENDING (CI mode)
"""
...
EXPECTED_SUBS: tuple[str, ...] = (    "discover",    "readme",    "landing",    "brand",)
