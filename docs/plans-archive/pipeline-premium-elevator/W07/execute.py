#!/usr/bin/env python3
"""W07.execute — Wave W07.

Forensic sub-script for W07 — Wave W07.

Outputs
-------
  - data/W07-execute.json   (machine-readable JSON envelope)
- staging/W07-execute.md  (human-readable narrative)
Usage
-----
