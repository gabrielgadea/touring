#!/usr/bin/env python3
"""validate_W11 — Per-wave validator for pipeline-premium-elevator.

Reads ``data/W11-*.json`` artifacts produced by the wave's sub-scripts
...
Usage
-----
    python3 validate_W11.py            # default — table output
    python3 validate_W11.py -j         # machine-readable JSON
    python3 validate_W11.py --strict   # exit 1 on PENDING (CI mode)
"""
