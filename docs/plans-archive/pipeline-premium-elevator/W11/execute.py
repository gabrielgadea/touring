#!/usr/bin/env python3
"""W11.execute — Wave W11.

Forensic sub-script for W11 — Wave W11.

Outputs
-------
  - data/W11-execute.json   (machine-readable JSON envelope)
- staging/W11-execute.md  (human-readable narrative)
Usage
-----
