#!/usr/bin/env python3
"""W06.execute — Wave W06.

Forensic sub-script for W06 — Wave W06.

Outputs
-------
  - data/W06-execute.json   (machine-readable JSON envelope)
- staging/W06-execute.md  (human-readable narrative)
Usage
-----
