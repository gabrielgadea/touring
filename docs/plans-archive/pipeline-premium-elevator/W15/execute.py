#!/usr/bin/env python3
"""W15.execute — PP4-pre audit for PP3 readiness (FC-2 fix).

Execute sub-script for W15 — verify PhaseConfig dataclass exists
...
FC: P1 | PP: PP4-pre | Wave: W15
Outputs
-------
  - data/W15-execute.json   (machine-readable)
  - staging/W15-execute.md  (human-readable)
