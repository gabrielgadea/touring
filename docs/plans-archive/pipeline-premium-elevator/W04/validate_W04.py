#!/usr/bin/env python3
"""validate_W04 — Per-wave validator for pipeline-premium-elevator.

Reads ``data/W04-*.json`` artifacts produced by the wave's sub-scripts
...
Usage
-----
    python3 validate_W04.py            # default — table output
    python3 validate_W04.py -j         # machine-readable JSON
    python3 validate_W04.py --strict   # exit 1 on PENDING (CI mode)
"""
