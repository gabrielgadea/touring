#!/usr/bin/env python3
"""validate_W01 — Per-wave validator for pipeline-premium-elevator.

Reads ``data/W01-*.json`` artifacts produced by the wave's sub-scripts
...
Usage
-----
    python3 validate_W01.py            # default — table output
    python3 validate_W01.py -j         # machine-readable JSON
    python3 validate_W01.py --strict   # exit 1 on PENDING (CI mode)
"""
