#!/usr/bin/env python3
"""W08.execute — Wave W08.

Forensic sub-script for W08 — Wave W08.

Outputs
-------
  - data/W08-execute.json   (machine-readable JSON envelope)
- staging/W08-execute.md  (human-readable narrative)
Usage
-----
