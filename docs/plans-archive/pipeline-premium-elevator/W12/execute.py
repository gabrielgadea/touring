#!/usr/bin/env python3
"""W12.execute — Wave W12.

Forensic sub-script for W12 — Wave W12.

Outputs
-------
  - data/W12-execute.json   (machine-readable JSON envelope)
- staging/W12-execute.md  (human-readable narrative)
Usage
-----
