...
**41 crates · 588,608 LOC (src)** — generated by `docs/sync_metrics.py --sync`; each crate's own `ARCHITECTURE.md` carries type-level detail. Largest crate is well under the 15% single-crate ceiling.
...
| 5 | `touring-hooks-core` | 33,468 | 5.7% |
