...
> <!-- METRICS: measured in loco 2026-08-19 via docs/sync_metrics.py --json (crates=42, loc_src=599625, loc_workspace=672451, test_fns=15952). Keep in sync via docs/sync_metrics.py (--check gate, now covers crates+LOC+test_fns). -->
>
...
> Previous: [ARCHITECTURE-historical-v29.5.0.md](ARCHITECTURE-historical-v29.5.0.md) — historical version (v29.5.0); current canonical lives in this file
...
**41 crates under `crates/` · 599,625 LOC (src)** — generated by `docs/sync_metrics.py --sync`; each crate's own `ARCHITECTURE.md` carries type-level detail. Largest crate is well under the 15% single-crate ceiling.

| # | crate | src LOC | % |
|--:|-------|--------:|--:|
| 1 | `touring-server` | 81,661 | 13.6% |
| 2 | `touring-intelligence` | 72,277 | 12.1% |
| 3 | `touring-analysis` | 38,866 | 6.5% |
| 4 | `touring-dispatch` | 37,525 | 6.3% |
| 5 | `touring-cli` | 32,259 | 5.4% |
| 6 | `touring-cortex` | 30,342 | 5.1% |
| 7 | `touring-bindings` | 30,277 | 5.0% |
| 8 | `touring-code` | 30,202 | 5.0% |
| 9 | `touring-hooks-core` | 29,742 | 5.0% |
| 10 | `touring-foundation` | 28,956 | 4.8% |
| 11 | `touring-hook-handlers` | 26,920 | 4.5% |
| 12 | `touring-hook-runtime` | 20,503 | 3.4% |
| 13 | `touring-quality` | 19,412 | 3.2% |
| 14 | `touring-ceg` | 19,223 | 3.2% |
| 15 | `touring-storage` | 17,425 | 2.9% |
| 16 | `touring-hooks-shared` | 14,858 | 2.5% |
| 17 | `touring-generator` | 13,879 | 2.3% |
| 18 | `touring-offensive` | 10,891 | 1.8% |
| 19 | `touring-simd` | 9,593 | 1.6% |
| 20 | `touring-hooks-prediction` | 5,556 | 0.9% |
| 21 | `touring-server-reasoning` | 5,161 | 0.9% |
| 22 | `inferlets` | 3,995 | 0.7% |
...
| 28 | `touring-hooks` | 1,346 | 0.2% |
| 29 | `touring-rkyv` | 1,301 | 0.2% |
| 30 | `touring-hooks-rl` | 1,272 | 0.2% |
| 31 | `touring-lsp` | 824 | 0.1% |
| 32 | `touring-server-session` | 726 | 0.1% |
| 33 | `touring-hooks-saga` | 672 | 0.1% |
| 34 | `touring-license` | 367 | 0.1% |
