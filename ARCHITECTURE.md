...
**41 crates · 588,487 LOC (src)** — generated by `docs/sync_metrics.py --sync`; each crate's own `ARCHITECTURE.md` carries type-level detail. Largest crate is well under the 15% single-crate ceiling.

| # | crate | src LOC | % |
|--:|-------|--------:|--:|
| 1 | `touring-server` | 77,950 | 13.2% |
| 2 | `touring-intelligence` | 69,643 | 11.8% |
| 3 | `touring-analysis` | 39,162 | 6.7% |
| 4 | `touring-dispatch` | 37,399 | 6.4% |
| 5 | `touring-hooks-core` | 33,458 | 5.7% |
| 6 | `touring-cortex` | 30,339 | 5.2% |
| 7 | `touring-bindings` | 30,277 | 5.1% |
| 8 | `touring-code` | 30,001 | 5.1% |
| 9 | `touring-cli` | 29,881 | 5.1% |
| 10 | `touring-hook-handlers` | 26,847 | 4.6% |
| 11 | `touring-foundation` | 26,433 | 4.5% |
| 12 | `touring-hook-runtime` | 19,317 | 3.3% |
| 13 | `touring-ceg` | 19,209 | 3.3% |
| 14 | `touring-quality` | 19,127 | 3.3% |
| 15 | `touring-storage` | 16,143 | 2.7% |
| 16 | `touring-hooks-shared` | 14,838 | 2.5% |
| 17 | `touring-generator` | 13,879 | 2.4% |
| 18 | `touring-offensive` | 10,891 | 1.9% |
