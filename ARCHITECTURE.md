...
**41 crates · 588,603 LOC (src)** — generated by `docs/sync_metrics.py --sync`; each crate's own `ARCHITECTURE.md` carries type-level detail. Largest crate is well under the 15% single-crate ceiling.

| # | crate | src LOC | % |
|--:|-------|--------:|--:|
| 1 | `touring-server` | 77,941 | 13.2% |
| 2 | `touring-intelligence` | 69,667 | 11.8% |
| 3 | `touring-analysis` | 39,162 | 6.7% |
| 4 | `touring-dispatch` | 37,408 | 6.4% |
| 5 | `touring-hooks-core` | 33,463 | 5.7% |
| 6 | `touring-cortex` | 30,339 | 5.2% |
| 7 | `touring-bindings` | 30,277 | 5.1% |
| 8 | `touring-code` | 30,001 | 5.1% |
| 9 | `touring-cli` | 29,919 | 5.1% |
| 10 | `touring-hook-handlers` | 26,870 | 4.6% |
| 11 | `touring-foundation` | 26,433 | 4.5% |
| 12 | `touring-hook-runtime` | 19,316 | 3.3% |
| 13 | `touring-ceg` | 19,209 | 3.3% |
| 14 | `touring-quality` | 19,150 | 3.3% |
