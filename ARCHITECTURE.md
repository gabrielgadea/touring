...
**49 crates · 539,727 LOC (src)** — generated by `docs/sync_metrics.py --sync`; each crate's own `ARCHITECTURE.md` carries type-level detail. Largest crate is well under the 15% single-crate ceiling.

| # | crate | src LOC | % |
|--:|-------|--------:|--:|
| 1 | `touring-server` | 71,171 | 13.2% |
| 2 | `touring-intelligence` | 68,107 | 12.6% |
| 3 | `touring-dispatch` | 37,521 | 7.0% |
| 4 | `touring-hooks-core` | 32,304 | 6.0% |
| 5 | `touring-bindings` | 30,282 | 5.6% |
| 6 | `touring-cortex` | 30,069 | 5.6% |
| 7 | `touring-code` | 28,561 | 5.3% |
| 8 | `touring-foundation` | 27,020 | 5.0% |
| 9 | `touring-hook-handlers` | 26,453 | 4.9% |
| 10 | `touring-cli` | 26,298 | 4.9% |
| 11 | `touring-hook-runtime` | 19,025 | 3.5% |
| 12 | `touring-ceg` | 18,387 | 3.4% |
| 13 | `touring-storage` | 15,729 | 2.9% |
| 14 | `touring-analysis` | 15,591 | 2.9% |
| 15 | `touring-hooks-shared` | 14,751 | 2.7% |
| 16 | `touring-generator` | 13,804 | 2.6% |
| 17 | `touring-offensive` | 10,592 | 2.0% |
| 18 | `touring-simd` | 9,340 | 1.7% |
| 19 | `touring-quality` | 7,444 | 1.4% |
| 20 | `touring-hooks-prediction` | 5,537 | 1.0% |
| 21 | `touring-server-reasoning` | 4,637 | 0.9% |
| 22 | `inferlets` | 4,026 | 0.7% |
| 23 | `touring-resilience` | 3,991 | 0.7% |
| 24 | `touring-orchestration` | 2,938 | 0.5% |
| 25 | `touring-harness` | 2,922 | 0.5% |
| 26 | `touring-server-visual` | 2,922 | 0.5% |
| 27 | `touring-assists` | 2,177 | 0.4% |
| 28 | `touring-identity` | 1,683 | 0.3% |
| 29 | `touring-hooks-rl` | 1,272 | 0.2% |
| 30 | `touring-hooks` | 1,159 | 0.2% |
| 31 | `touring-rkyv` | 907 | 0.2% |
| 32 | `touring-server-session` | 726 | 0.1% |
| 33 | `touring-hooks-saga` | 672 | 0.1% |
| 34 | `touring-lsp` | 622 | 0.1% |
| 35 | `touring-harness-mcp` | 435 | 0.1% |
| 36 | `touring-license` | 345 | 0.1% |
| 37 | `touring-contracts` | 103 | 0.0% |
| 38 | `touring-ast-polyglot` | 36 | 0.0% |
| 39 | `touring-web-server` | 25 | 0.0% |
| 40 | `touring-ast` | 18 | 0.0% |
| 41 | `touring-capnp-server` | 17 | 0.0% |
| 42 | `touring-loom-proofs` | 17 | 0.0% |
| 43 | `touring-antt` | 15 | 0.0% |
| 44 | `touring-learning` | 15 | 0.0% |
| 45 | `touring-cognitive` | 14 | 0.0% |
| 46 | `touring-integration-tests` | 12 | 0.0% |
| 47 | `touring-wasm` | 12 | 0.0% |
| 48 | `touring-web` | 12 | 0.0% |
| 49 | `touring-python` | 11 | 0.0% |
<!-- CRATES:END -->
