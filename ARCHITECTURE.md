...
**41 crates · 584,241 LOC (src)** — generated by `docs/sync_metrics.py --sync`; each crate's own `ARCHITECTURE.md` carries type-level detail. Largest crate is well under the 15% single-crate ceiling.

| # | crate | src LOC | % |
|--:|-------|--------:|--:|
| 1 | `touring-server` | 77,554 | 13.3% |
| 2 | `touring-intelligence` | 68,833 | 11.8% |
| 3 | `touring-analysis` | 39,177 | 6.7% |
| 4 | `touring-dispatch` | 37,350 | 6.4% |
| 5 | `touring-hooks-core` | 32,686 | 5.6% |
| 6 | `touring-cortex` | 30,345 | 5.2% |
| 7 | `touring-bindings` | 30,284 | 5.2% |
| 8 | `touring-code` | 30,026 | 5.1% |
...
| 29 | `touring-hooks` | 1,221 | 0.2% |
| 30 | `touring-rkyv` | 916 | 0.2% |
| 31 | `touring-lsp` | 822 | 0.1% |
