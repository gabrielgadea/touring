...
**41 crates · 584,324 LOC (src)** — generated by `docs/sync_metrics.py --sync`; each crate's own `ARCHITECTURE.md` carries type-level detail. Largest crate is well under the 15% single-crate ceiling.
