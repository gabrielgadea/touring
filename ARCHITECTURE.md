...
**41 crates · 597,561 LOC (src)** — generated by `docs/sync_metrics.py --sync`; each crate's own `ARCHITECTURE.md` carries type-level detail. Largest crate is well under the 15% single-crate ceiling.

| # | crate | src LOC | % |
|--:|-------|--------:|--:|
| 1 | `touring-server` | 80,937 | 13.5% |
| 2 | `touring-intelligence` | 69,653 | 11.7% |
| 3 | `touring-analysis` | 38,773 | 6.5% |
| 4 | `touring-dispatch` | 37,371 | 6.3% |
| 5 | `touring-hooks-core` | 33,867 | 5.7% |
| 6 | `touring-cli` | 31,224 | 5.2% |
| 7 | `touring-cortex` | 30,339 | 5.1% |
| 8 | `touring-bindings` | 30,277 | 5.1% |
| 9 | `touring-code` | 30,130 | 5.0% |
| 10 | `touring-foundation` | 28,654 | 4.8% |
| 11 | `touring-hook-handlers` | 26,892 | 4.5% |
| 12 | `touring-hook-runtime` | 19,483 | 3.3% |
| 13 | `touring-quality` | 19,404 | 3.2% |
| 14 | `touring-ceg` | 19,209 | 3.2% |
| 15 | `touring-storage` | 17,335 | 2.9% |
| 16 | `touring-hooks-shared` | 14,842 | 2.5% |
| 17 | `touring-generator` | 13,879 | 2.3% |
| 18 | `touring-offensive` | 10,891 | 1.8% |
| 19 | `touring-simd` | 9,587 | 1.6% |
