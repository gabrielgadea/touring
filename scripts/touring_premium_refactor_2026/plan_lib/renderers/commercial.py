...
Extracted from renderers.py lines 650-897. Each module owns one logical
...
def render_commercial_md() -> str:
    """Render 03-COMMERCIAL.md — tiers + GTM strategy."""
    meta = {
        "plan": _PLAN_NAME,
        "version": _VERSION,
        "type": "commercial",
        "created": _TODAY,
        "relates_to": ["01-ARCHITECTURE.md", "02-DEPLOYMENT.md",
    ...
    body = textwrap.dedent(f"""\
        ...
        > **Approved by**: {_AUTHOR_GABRIEL} — "tiers integrated into roadmap as W14"
