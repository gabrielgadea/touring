...
Extracted from renderers.py lines 1336-1479. Each module owns one logical
...
def render_rollback_md() -> str:
    """Render 07-ROLLBACK.md — rollback procedures per wave."""
    meta = {"plan": _PLAN_NAME, "version": _VERSION, "type": "rollback", "created": _TODAY}
