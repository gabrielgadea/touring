...
Extracted from renderers.py lines 417-649. Each module owns one logical
...
def render_deployment_md() -> str:
    """Render 02-DEPLOYMENT.md — per-project rustup-like deployment."""
    meta = {
        "plan": _PLAN_NAME,
        "version": _VERSION,
        "type": "deployment",
        "created": _TODAY,
        "relates_to": ["01-ARCHITECTURE.md", "03-COMMERCIAL.md",
    ...
    body = textwrap.dedent(f"""\
        ...
        > **Approved by**: {_AUTHOR_GABRIEL} — "rustup-like AFTER architectural refactor; must serve external clients"
